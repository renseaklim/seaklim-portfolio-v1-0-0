<template>
    <section class="h-[95vh] bg-yellow-700/20 dark:bg-slate-950/50 z-10 relative" id="about">
        <div class="container max-w-screen-xl h-full flex max-md:flex-col items-center justify-center gap-11 z-10">
            <div class="relative">
                ...
                <img src="@/assets/img/presentation-img1.jpg" alt=""
                    class="max-w-[30rem] max-lg:max-w-[25rem] max-md:w-[20rem] max-sm:w-[15rem] rounded-2xl shadow-md -z-10
